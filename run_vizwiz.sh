...
IMAGENET_PRETRAIN=/home/turje87/DeFRCN/data/.pretrain_weights/ImageNetPretrained/MSRA/R-101.pkl
IMAGENET_PRETRAIN_TORCH=/home/turje87/DeFRCN/data/.pretrain_weights/ImageNetPretrained/torchvision/resnet101-5d3b4d8f.pth
IMAGENET_PRETRAIN=/home/turje87/DeFRCN/data/.pretrain_weights/ImageNetPretrained/MSRA/R-101.pkl
IMAGENET_PRETRAIN_TORCH=/home/turje87/DeFRCN/data/.pretrain_weights/ImageNetPretrained/torchvision/resnet101-5d3b4d8f.pth
...
# ------------------------------ Novel Fine-tuning ------------------------------- #
# --> 2. TFA-like, i.e. run seed0~9 for robust results (G-FSOD, 80 classes)9
for seed in 0 
do
    for shot in 10
    do
