...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='coco', choices=['voc', 'coco', 'vizwiz'])
    ...
    if args.dataset == 'coco':
        ...
        # VizWiz has 100 classes (1-100) + background = 101
        # For surgery, we just use the simple approach (not COCO-style remapping)
        TAR_SIZE = 100
    else:
        raise NotImplementedError
